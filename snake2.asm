...
;---------------------------------------------------------------------------------
; updateSnake: update the snake, both in memory and on screen
; INPUT: length of snake, location of head of snake in memory, position of the head of the snake
; OUTPUT: none
proc updateSnake
	push bp
...
;---------------------------------------------------------------------------------
; manageEat: manage all things eating related
; INPUT: next snake position, length of snake, location of snake in memory, the seed
; OUTPUT: new seed, new length
proc manageEat
	push bp
	mov bp, sp
	push bx
